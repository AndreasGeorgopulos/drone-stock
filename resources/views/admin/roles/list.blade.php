            ...
            <div class="col-sm-12">
                <table class="table table-bordered table-striped dataTable">
                    ...
                    <tr role="row">
                        ...
                        <th data-column="name">{{trans('admin.Név')}}</th>
                        <th data-column="description">{{trans('admin.Leírás')}}</th>
                        <th>
                            <a href="{{url(route('admin_roles_edit'))}}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> {{trans('admin.Új jogosultság')}}</a>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="{{url(route('admin_roles_edit', ['id' => $model->id]))}}"><i class="fa fa-edit"></i> {{trans('admin.Szerkesztés')}}</a></li>
                                        <li class="divider"></li>
                                        <li><a href="{{url(route('admin_roles_delete', ['id' => $model->id]))}}" class="confirm"><i class="fa fa-trash"></i> {{trans('admin.Törlés')}}</a></li>
                                    </ul>
                                </div>
