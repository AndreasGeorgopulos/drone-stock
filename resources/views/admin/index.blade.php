        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">{{trans('admin.Elvetés')}}</button>
                    <button type="button" class="btn btn-primary yes_btn">{{trans('admin.Végrehajtom a műveletet')}}</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
