<div class="row">
    <div class="col-sm-6">
        <div class="dataTables_length">
            <label>{{trans('admin.Elemek száma oldalanként')}}:
    ...
    <div class="col-sm-6">
        <div class="input-group pull-right">
            <input type="text" name="searchtext" class="form-control input-sm" placeholder="{{trans('admin.Keresés')}}..." value="{{$searchtext}}" />
